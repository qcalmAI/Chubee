...
# wolf. Verified benign here: s6-log lock contention fires continuously (60k+
# times/18h) while the gateway works perfectly — a supervision quirk, not a fault.
# Add patterns (pipe-separated, grep -E) only after CONFIRMING they're harmless.
